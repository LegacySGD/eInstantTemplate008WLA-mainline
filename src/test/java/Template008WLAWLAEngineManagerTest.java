...
public class Template008WLAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(Template008WLAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/Template008WLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/Template008WLAIW/InitOutcome.xml").getDocumentElement();
